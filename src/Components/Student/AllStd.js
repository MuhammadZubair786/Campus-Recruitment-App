    ...
    < View style={{ flex: 1 }}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <ScrollView>
            ...
            <View style={{ justifyContent: 'center', alignContent: 'center', alignItems: 'center', marginTop: 20,backgroundColor:'white' }}>
                <Text style={{ fontSize: 30, color: 'red', fontWeight: 'bold', textAlign: 'center' }}>
                  All Students Data
                    </Text>
            ...
            {data.map((v, i) => {
              ...
              return (
                ...
                <View key={i} style={{ marginTop: '8%', padding: '2%', borderWidth: 2, borderColor: '#C2C1C0', backgroundColor: '#F2EDE4', borderRadius: 20 }} >
